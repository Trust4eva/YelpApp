# YelpApp
# Project 3 - *YelpServices*

**YelpServices** is a Yelp search app using the [Yelp API](http://www.yelp.com/developers/documentation/v2/search_api).
